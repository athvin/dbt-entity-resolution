...
| 2 | Parity with Splink demonstrated, bounded, published | 🟡 comparator proved able to fail | Stage 0.7's sensitivity suite green: 11 mutants, none survives, each asserting its localisation string. No parity *claim* yet — there are no stages to compare (PC-2). |
...
|---|---|
| PR | *(pending — PC-3)* |
| Branch | `docs/pc3-b8-lateral-alias-spike` |
| Head SHA | *(pending)* |
| Task | PC-3 (Stage 0.8) |
