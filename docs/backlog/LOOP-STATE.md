...
**In flight:** PA-7 — close DR-08 and DR-09, the threshold contract.

**Done:** PL-0 (#1, `5711322`) · PA-1 (#2, `59e8d93`) · PA-2 (#3, `297f25d`) · PA-3 (#4, `61995e5`) · PA-4 (#5, `3d12e83`) · PA-5 (#6, `4773e2c`) · PA-6 (#7, `df53def`) · PA-7 (#8)
