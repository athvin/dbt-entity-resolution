...
**In flight:** PA-9 — register B.8, decide B.9, settle two UNVERIFIED claims.

**Done:** PL-0 (#1) · PA-1 (#2) · PA-2 (#3) · PA-3 (#4) · PA-4 (#5) · PA-5 (#6) · PA-6 (#7) · PA-7 (#8) · PA-8 (#9, `ea9bedf`) · PA-9 (#10)
