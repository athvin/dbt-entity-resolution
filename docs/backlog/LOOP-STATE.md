...
**In flight:** PB-4a — the four enforcement scripts, their failing-case tests, and pre-commit.

**Done:** PL-0 (#1) · PA-1 (#2) · PA-2 (#3) · PA-3 (#4) · PA-4 (#5) · PA-5 (#6) · PA-6 (#7) · PA-7 (#8) · PA-8 (#9) · PA-9 (#10) · PB-1 (#11) · PB-2/PB-3 (`c7ffae6`, unreviewed — see below) · PL-1 (#12, `09c3dab`) · PB-4a (#13)
